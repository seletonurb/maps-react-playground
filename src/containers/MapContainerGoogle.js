...
const GoogleMapContainer = ({ currentTab, currentItineraryEventId, currentGeofenceId, itineraryEvents, geofences, searchPlace, onMapsLoaded }) => {
    useEffect(() => {
        setSelectedMarkerId(currentItineraryEventId ? currentItineraryEventId : null);
    }, [currentItineraryEventId]);

    useEffect(() => {
        setSelectedMarkerId(currentGeofenceId ? currentGeofenceId : null);
    }, [currentGeofenceId]);
